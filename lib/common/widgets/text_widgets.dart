...
class Text16Normal extends StatelessWidget {
  ...
  const Text16Normal({Key? key, this.text ="", this.color= AppColors.primarySecondaryElementText, this.fontWeight= FontWeight.normal}): super(key: key);
...
class Text14Normal extends StatelessWidget {
  ...
  const Text14Normal({Key? key, this.text = "", this.color = AppColors
